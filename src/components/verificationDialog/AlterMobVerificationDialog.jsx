...
const AlterMobVerificationDialog = ({ setVerifiedAlterMo, setAlterMobverifyBtn, handleAlterMoClose ,open = true, onClose }) => {
  ...
  const handleVerifiedOtp = () =>{
    ...
    setAlterMobverifyBtn(false)
    setVerifiedAlterMo(true)
    handleAlterMoClose()
    onClose()
  }
...
export default AlterMobVerificationDialog;
